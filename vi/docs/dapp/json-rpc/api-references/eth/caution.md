...
| hash                    | hash                    | :white_check_mark: Hàm băm của khối.                                                                                                                                                                                                                                                                                                                                                                                               |
| logsBloom               | logsBloom               | :white_check_mark: Bộ lọc Bloom cho các bản ghi của khối. Giá trị là `null` nếu đó là khối đang chờ xử lý.                                                                                                                                                                                                                                                                                                                         |
...
| parentHash              | parentHash              | :white_check_mark: Hàm băm của khối cha.                                                                                                                                                                                                                                                                                                                                                                                           |
...
| sha3Uncles              | (đã thêm)               | :warning: Trường này luôn có giá trị `0x1dcc4de8dec75d7aab85b567b6ccd41ad312451b948a7413f0a142fd40d49347`, là giá trị băm Keccak256 của các byte được mã hóa RLP của danh sách chứa tiêu đề khối trống vì không có khối chú trên Klaytn.                                                                                                                                                                                             |
...
**Giao dịch LegacyTransaction Klaytn** được trình bày dưới dạng Giao dịch cũ Ethereum như dưới đây.
```json
{
  "jsonrpc": "2.0",
  "id": 1,
...
| ---------------------------------- | ------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| blockHash                          | blockHash                                                                             | :white_check_mark: Hàm băm của khối.                                                                                                                                                                                                                   |
| blockNumber                        | blockNumber                                                                           | :white_check_mark: Số khối.                                                                                                                                                                                                                            |
...
| logs                               | logs                                                                                  | :white_check_mark: Mảng bao gồm các đối tượng bản ghi được tạo bởi giao dịch.                                                                                                                                                                          |
| logsBloom                          | logsBloom                                                                             | :white_check_mark: Bộ lọc Bloom cho các ứng dụng khách nhẹ để nhanh chóng truy xuất các bản ghi liên quan.                                                                                                                                             |
