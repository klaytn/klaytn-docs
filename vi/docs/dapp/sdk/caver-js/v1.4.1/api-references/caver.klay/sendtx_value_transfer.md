# Giao dịch chuyển giá trị <a id="value-transfer-transaction"></a>
...
```
Gửi giao dịch [Chuyển giá trị](../../../../../../klaytn/design/transactions/basic.md#txtypevaluetransfer) đến mạng.
...
caver.klay.sendTransaction(transactionObject [, callback])
```
Gửi giao dịch [Chuyển giá trị có ủy thác phí](../../../../../../klaytn/design/transactions/fee-delegation.md#txtypefeedelegatedvaluetransfer) đến mạng.
...
caver.klay.sendTransaction(transactionObject [, callback])
```
Gửi giao dịch [Chuyển giá trị có ủy thác phí theo tỷ lệ](../../../../../../klaytn/design/transactions/partial-fee-delegation.md#txtypefeedelegatedvaluetransferwithratio) đến mạng.
