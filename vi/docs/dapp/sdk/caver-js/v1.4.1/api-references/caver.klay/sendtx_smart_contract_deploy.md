# Giao dịch triển khai hợp đồng thông minh <a id="smart-contract-deploy-transaction"></a>
...
```
Gửi giao dịch [Triển khai hợp đồng thông minh](../../../../../../klaytn/design/transactions/basic.md#txtypesmartcontractdeploy) đến mạng.
...
caver.klay.sendTransaction(transactionObject [, callback])
```
Gửi giao dịch [Triển khai hợp đồng thông minh có ủy thác phí](../../../../../../klaytn/design/transactions/fee-delegation.md#txtypefeedelegatedsmartcontractdeploy) đến mạng.
...
caver.klay.sendTransaction(transactionObject [, callback])
```
Gửi giao dịch [Triển khai hợp đồng thông minh có ủy thác phí theo tỷ lệ](../../../../../../klaytn/design/transactions/partial-fee-delegation.md#txtypefeedelegatedsmartcontractdeploywithratio) đến mạng.
