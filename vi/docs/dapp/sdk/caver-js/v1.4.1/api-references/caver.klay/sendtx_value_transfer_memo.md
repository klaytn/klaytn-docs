# Giao dịch chuyển giá trị kèm ghi chú <a id="value-transfer-memo-transaction"></a>
...
```
Gửi giao dịch [Chuyển giá trị kèm ghi chú](../../../../../../klaytn/design/transactions/basic.md#txtypevaluetransfermemo) đến mạng.
...
caver.klay.sendTransaction(transactionObject [, callback])
```
Gửi giao dịch [Chuyển giao dịch có ủy thác phí kèm ghi chú](../../../../../../klaytn/design/transactions/fee-delegation.md#txtypefeedelegatedvaluetransfermemo) đến mạng.
...
caver.klay.sendTransaction(transactionObject [, callback])
```
Gửi giao dịch [Chuyển giá trị có ủy thác phí theo tỷ lệ kèm ghi chú](../../../../../../klaytn/design/transactions/partial-fee-delegation.md#txtypefeedelegatedvaluetransfermemowithratio) đến mạng.
