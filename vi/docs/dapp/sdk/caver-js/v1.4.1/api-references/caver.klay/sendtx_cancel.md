...
```
Gửi giao dịch [Hủy](../../../../../../klaytn/design/transactions/basic.md#txtypecancel) đến mạng.
...
caver.klay.sendTransaction(transactionObject [, callback])
```
Gửi giao dịch [Hủy có ủy thác phí](../../../../../../klaytn/design/transactions/fee-delegation.md#txtypefeedelegatedcancel) đến mạng.
...
caver.klay.sendTransaction(transactionObject [, callback])
```
Gửi giao dịch [Hủy có ủy thác phí theo tỷ lệ](../../../../../../klaytn/design/transactions/partial-fee-delegation.md#txtypefeedelegatedcancelwithratio) đến mạng.
