## Gửi KLAY dành cho người mới bắt đầu <a id="sending-klay-at-a-glance"></a>
...
![Bộ công cụ trực tuyến của Klaytn](../images/keystore.png)

Hãy tải về tập tin lưu trữ khóa, và đổi thành một cái tên đơn giản hơn, ví dụ như `keystore.json`.

**Bạn cần KLAY để gửi một giao dịch.** Bạn có thể nhận KLAY thử nghiệm cho mạng thử nghiệm Baobab từ [Vòi](https://baobab.wallet.klaytn.foundation/faucet). Hãy tham khảo [Ví Klaytn](../../../toolkit/klaytn-wallet.md#how-to-receive-baobab-testnet-klay) để xem hướng dẫn chi tiết.
...
![Nhập mật khẩu của bạn](../images/prompt.png)
