...
`LegacyTransaction` biểu thị một [giao dịch cũ](../../../../../klaytn/design/transactions/basic.md#txtypelegacytransaction). [Tài khoản Klaytn](../../../../../klaytn/design/tài khoảns.md#klaytn-tài khoảns) có thể thực thi `LegacyTransaction` chỉ bằng [AccountKeyLegacy (Khóa tài khoản cũ)][]. `transactionObject` có thể có các thuộc tính dưới đây để tạo `LegacyTransaction`.
...
[AccountKeyLegacy (Khóa tài khoản cũ)]: ../../../../../klaytn/design/tài khoảns.md#tài khoảnkeylegacy
[Tài khoản]: ../caver.account.md#account
[Tài khoản]: ../caver.tài khoản.md#tài khoản
