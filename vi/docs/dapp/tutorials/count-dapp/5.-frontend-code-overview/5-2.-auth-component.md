...
Cả file lưu trữ khóa và mật khẩu của file này đã sẵn sàng để sử dụng. Giờ đây chúng tôi có thể giải mã file lưu trữ khóa để trích xuất khóa riêng tư bằng API `cav.klay.accounts.decrypt(keystore, password)`.\
