...
### PHƯƠNG PHÁP TRIỂN KHAI 1: Bằng khóa riêng tư <a href="#deploy-method-1-by-private-key" id="deploy-method-1-by-private-key"></a>
...
```javascript
{
 ...
 nhà cung cấp: new HDWalletProvider(
   ...
   'https://public-en-baobab.klaytn.net', // Nếu bạn đang chạy nút đầy đủ, bạn có thể đặt url rpc của nút.
  ),
 ...
}
```
...
/**
 * Chúng tôi trích xuất `URL`, `KHÓA_RIÊNG_TƯ` dưới dạng hằng biến để có thể đặt giá trị dễ dàng.
