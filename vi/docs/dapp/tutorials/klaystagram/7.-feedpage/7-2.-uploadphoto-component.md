...
* Sau khi phiên bản giao dịch đã ký của bạn được xây dựng đúng cách, sự kiện `transactionHash` sẽ được kích hoạt. Bạn có thể lấy mã băm của giao dịch trước khi gửi giao dịch lên mạng lưới.
