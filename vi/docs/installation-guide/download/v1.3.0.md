...
- Dấu hiệu của loại giao dịch Klaytn qua API RPC (klay_signTransaction and klay_signTransactionAsFeePayer).
...
- Đã sửa block lỗi sai không thường xuyên do bỏ qua cập nhật trạng thái.
