...
* Cải thiện tin nhắn nhật ký chuỗi dịch vụ
...
* Cải thiện nhật ký và thông số prometheus
...
* Cải thiện mã thử, thông số và tin nhắn nhật ký
...
* Sử dụng worker pool trong fetcher để giới hạn goroutine cho insertChain
* Cập nhật cấu hình daemon nút
* Nâng cao mã thử, thông số và tin nhắn nhật ký
...
* Cải thiện thông số prometheus, tin nhắn nhật ký và mã thử
