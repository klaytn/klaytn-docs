...
# Thông tin phiên bản <a id="release-notes"></a>

## Tính năng mới
- Triển khai mô-đun streaming để đẩy dữ liệu blockchain đã tìm nạp vào Kafka theo thời gian thực
...
## Khác
- Thêm các tùy chọn để vô hiệu hóa Fetcher/Downloader/Worker (#680, #688)
- Triển khai tạo khối khởi nguyên với dữ liệu chuỗi hiện có (#649)
- Gỡ cờ không sử dụng `--cache.writethrough` (#682)
- Thêm nhật ký lỗi khi đọc trie DB không thành công (#683)
...
- Thêm các thông số hiệu suất đọc/viết cho Level DB (#726) 
