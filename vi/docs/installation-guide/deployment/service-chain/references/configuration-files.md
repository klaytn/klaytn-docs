...
| SỐ LIỆU                        | Kích hoạt bộ sưu tập số liệu và báo cáo nếu đặt nó là 1.                                                                                                                                                                                                                           |
...
| ĐA KÊNH                        | Tạo một kênh chuyên dụng để truyền khối nếu đặt nó là 1.                                                                                                                                                                                                                           |
| CỔNG PHỤ                       | Lắng nghe số cổng phụ nếu kích hoạt tùy chọn Đa kênh. (Mặc định : "32324")                                                                                                                                                                                                         |
| NO_DISCOVER                    | Tắt tùy chọn Khám phá nếu đặt nó là 1.                                                                                                                                                                                                                                             |
| BOOTNODE                       | Địa chỉ kni của các nút bootstrap được phân tách bằng dấu phẩy.                                                                                                                                                                                                                    |
| BỔ SUNG                        | Cho các tùy chọn dòng lệnh bổ sung. e.g) --txpool.nolocals                                                                                                                                                                                                                         |
