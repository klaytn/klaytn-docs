...
{% hint style="success" %}
注意: RLPエンコードされた文字列から `FeeDelegatedValueTransfer` のインスタンスを作成できます。 Please refer to the below example. 注意: `caver.transaction.feeDelegatedValueTransfer.create` は caver-js [v1.6.1](https://www.npmjs.com/package/caver-js/v/1.6.1) からサポートされています。
...
| feePayerSignatures | Array  | (オプション) feePayerSignaturesの配列。                                                                                                                                       |
| feePayer           | string | (オプション) 手数料支払者の住所。                                                                                                                                                   |
...
| chainId            | string | (オプション) KlaytnブロックチェーンプラットフォームのチェーンID(このドキュメントの残りの部分については「Klaytn」と略称されます)。 If omitted, `caver.rpc.klay.getChainId` will be used to set chainId.                      |
...
{% hint style="success" %}
注意: RLPエンコードされた文字列から `FeeDelegatedValueTransferMemo` のインスタンスを作成できます。 Please refer to the below example. 注意: `caver.transaction.feeDelegatedValueTransferMemo.create` は caver-js [v1.6.1](https://www.npmjs.com/package/caver-js/v/1.6.1) からサポートされています。
...
| nonce              | string | (optional) A value used to uniquely identify a sender’s transaction. If omitted, `caver.rpc.klay.getTransactionCount(address, 'pending')` will be used to set nonce. |
| gasPrice           | string | (optional) A multiplier to get how much the sender will pay in tokens. If omitted, `caver.rpc.klay.getGasPrice` will be used to set gasPrice.                        |
| chainId            | string | (オプション) KlaytnのチェーンID。 If omitted, `caver.rpc.klay.getChainId` will be used to set chainId.                                                                          |
...
{% hint style="success" %}
注意: RLP でエンコードされた文字列から `FeeDelegatedAccountUpdate` のインスタンスを作成できます。 Please refer to the below example. 注意: `caver.transaction.feeDelegatedAccountUpdate.create` は caver-js [v1.6.1](https://www.npmjs.com/package/caver-js/v/1.6.1) からサポートされています。
...
| ------------------ | --------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| from               | string    | The address of the sender.                                                                                                                                           |
| account            | [Account] | アカウントを更新するために必要な情報を含む [Account] インスタンス。                                                                                                                              |
| gas                | string    | The maximum amount of transaction fee the transaction is allowed to use.                                                                                             |
| signatures         | Array     | (optional) An array of signatures.                                                                                                                                   |
| feePayerSignatures | Array     | (optional) An array of feePayerSignatures.                                                                                                                           |
| feePayer           | string    | (optional) The address of fee payer.                                                                                                                                 |
...
{% hint style="success" %}
注意: RLPエンコードされた文字列から `FeeDelegatedSmartContractDeploy` のインスタンスを作成できます。 Please refer to the below example. 注意: `caver.transaction.feeDelegatedSmartContractDeploy.create` は caver-js [v1.6.1](https://www.npmjs.com/package/caver-js/v/1.6.1) からサポートされています。
...
{% hint style="success" %}
注意: RLPエンコードされた文字列から `FeeDelegatedSmartContractExecution` のインスタンスを作成できます。 Please refer to the below example. 注意: `caver.transaction.feeDelegatedSmartContractExecution.create` は caver-js [v1.6.1](https://www.npmjs.com/package/caver-js/v/1.6.1) からサポートされています。
...
| input              | string | Data attached to the transaction, used for transaction execution. The input is an encoded string that indicates a function to call and parameters to be passed to this function. このエンコードされた文字列は [caver.abi.encodeFunctionCall](../caver.abi.md#encodefunctioncall) で取得できます。 |
| gas                | string | The maximum amount of transaction fee the transaction is allowed to use.                                                                                                                                                                                                    |
| value              | string | (optional, default: `'0x0'`) The amount of KLAY in peb to be transferred. You can use `caver.utils.toPeb`.                                                                                                                                                                  |
| signatures         | Array  | (optional) An array of signatures.                                                                                                                                                                                                                                          |
| feePayerSignatures | Array  | (optional) An array of feePayerSignatures.                                                                                                                                                                                                                                  |
...
{% hint style="success" %}
注意: RLPエンコードされた文字列から `FeeDelegatedCancel` のインスタンスを作成することができます。 Please refer to the below example. 注意: `caver.transaction.feeDelegatedCancel.create` は caver-js [v1.6.1](https://www.npmjs.com/package/caver-js/v/1.6.1) からサポートされています。
...
{% hint style="success" %}
注意: RLPエンコードされた文字列から `FeeDelegatedChainDataAnchoring` のインスタンスを作成できます。 Please refer to the below example. 注意: `caver.transaction.feeDelegatedChainDataAnchoring.create` は caver-js [v1.6.1](https://www.npmjs.com/package/caver-js/v/1.6.1) からサポートされています。
