...
## Fixes
 - `eth_getTransactionReceipt`API (#1257) でイーサリアムで同じレシートステータスを返すように修正。
 - rawトランザクションAPIから `EthereumTxTypeEnvelope` を削除しました (#1264)
 - `eth` 名前空間 API (#1261 #1267) で存在しないブロックでは、null を返すように修正。