...
{% hint style="info" %}
**Note:** You can check this page for a tutorial on deploying smart contracts using [libraries](https://docs.klaytn.foundation/content/dapp/sdk) on Klaytn Baobab Testnet. You may also use a developer tool such as [Hardhat](https://docs.klaytn.foundation/content/getting-started/hardhat), [Foundry](https://docs.klaytn.foundation/content/getting-started/foundry), [Remix](https://docs.klaytn.foundation/content/smart-contract/deploy-guide#remix-ide)  or another tool if preferred, to deploy the smart contract to Klaytn Baobab Testnet.
{% endhint %}
...
* On Remix IDE, navigate to the **Solidity compiler tab**.
    ...
    * (Optional) If **optimization** is enabled during compilation, take note of the value of the optimization runs parameter
    ...
    ![](./img/counter-veri-parameters.png)
...
* On Remix IDE, navigate to **Klaytn tab**.
    ...
    * Take note of the contract address of the smart contract on the **Deployed Contracts** tab after successful deployment.
    ...
    ![](./img/counter-veri-parametersII.png)
...
![](./img/counter-success-popup-I.png)

![](./img/counter-full-verification.png)
...
![](./img/airdrop-veri-field-I.png)

b. Solidity File(s)

![](./img/airdrop-veri-field-II.png)
...
![](./img/airdrop-success-popup.png)

![](./img/airdrop-success-popup-I.png)

![](./img/airdrop-full-verification.png)
...
![](./img/klaytnfinder-con-sub-page.png)
...
![](./img/counter-k-verification-page.png)
...
> ![](./img/counter-k-full-verification.png)
...
![](./img/airdrop-k-verification-page.png)
...
![](./img/airdrop-k-full-verification.png)
