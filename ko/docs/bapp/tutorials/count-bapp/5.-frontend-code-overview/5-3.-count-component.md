...
컨트랙트의 인스턴스는 caver-js의 `caver.klay.Contract(ABI, contractAddress)` API를 통해 생성할 수 있습니다. 자세한 내용은 [caver.klay.Contract](../../../sdk/caver-js/api-references/caver.klay.Contract.md#new-contract)을 참고해주세요.
