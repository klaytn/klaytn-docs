...
As we described in [above](6.-frontend-code-overview.md#1-overview), `src/pages` contains two page files. 사용자의 로그인 여부에 따라 두 페이지 중 하나가 애플리케이션에 렌더링됩니다.
...
## 3\) What we are going to learn? <a id="3-what-we-are-going-to-learn"></a>
