...
* TX Type: 트랜잭션의 유형입니다. 필터를 적용하여 특정 유형의 트랜잭션을 조회할 수 있습니다. For more information, please visit [Transactions](../../klaytn/design/transactions/).
...
* TX Type: 트랜잭션의 유형입니다. For more information, please see [Transactions](../../klaytn/design/transactions/).
* Block \#: 해당 트랜잭션을 담은 블록의 번호입니다. 번호를 클릭하여 해당 블록의 상세 보기 페이지로 이동할 수 있습니다.
