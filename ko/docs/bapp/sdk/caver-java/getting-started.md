...
After creating an account, you can receive some Baobab testnet KLAY for the Baobab testnet via Baobab Faucet, available at <https://baobab.wallet.klaytn.com/>. The received testnet KLAY will be used for transaction fee later.
