...
| 명칭  | 형식     | 설명                      |
| --- | ------ | ----------------------- |
| 문자열 | String | HEX 문자열로 변환할 UTF-8 문자열. |
...
| 명칭  | 형식     | 설명                      |
| --- | ------ | ----------------------- |
| 문자열 | String | HEX 문자열로 변환할 ASCII 문자열. |
...
| 명칭                | 형식 | 설명                                          |
| ----------------- | -- | ------------------------------------------- |
| transactionObject | 객체 | 트랜잭션이 스마트 컨트랙트 배포용인지 사용자가 확인하고자 하는 트랜잭션 객체. |
