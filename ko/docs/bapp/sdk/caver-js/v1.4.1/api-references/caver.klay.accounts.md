...
| 명칭  | 형식     | 설명                                           |
| --- | ------ | -------------------------------------------- |
| 메시지 | String | 해시를 취할 메시지입니다.  HEX 문자열인 경우 먼저 UTF-8 디코딩됩니다. |
...
| 명칭            | 형식                   | 설명                                                       |
| ------------- | -------------------- | -------------------------------------------------------- |
| account       | String &#124; Object | [caver.klay.accounts.create](#create)로 생성된 개인키 또는 계정 객체. |
...
| 명칭      | 형식                   | 설명                |
| ------- | -------------------- | ----------------- |
| account | String &#124; Number | 지갑의 계좌 주소 또는 인덱스. |
