...
| 명칭 | 형식                                              | 설명            |
| -- | ----------------------------------------------- | ------------- |
| 복합 | String &#124; Number &#124; BN &#124; BigNumber | HEX로 변환할 입력값. |
...
| 단위     | String                         | (선택 사항, 기본값은 `"KLAY"`) 변환하고자 하는 KLAY. 가능한 단위는 다음과 같습니다:<br />- `peb`: '1' <br /> - `kpeb`: '1000' <br /> - `Mpeb`: '1000000' <br /> - `Gpeb`: '1000000000' <br /> - `Ston`: '1000000000' <br /> - `uKLAY`: '1000000000000' <br /> - `mKLAY`: '1000000000000000' <br /> - `KLAY`: '1000000000000000000' <br /> - `kKLAY`: '1000000000000000000000' <br /> - `MKLAY`: '1000000000000000000000000' <br /> - `GKLAY`: '1000000000000000000000000000' <br /> |
