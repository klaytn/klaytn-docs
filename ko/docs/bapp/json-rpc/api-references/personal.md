...
| passphrase | 문자열 | 암호화에 사용되는 비밀번호입니다.                                                                                                      |
...
| 명칭         | 형식  | 설명                         |
| ---------- | --- | -------------------------- |
| passphrase | 문자열 | (선택 사항) 암호화에 사용되는 비밀번호입니다. |
...
| ------------- | --- | ----------------------------------------------------------------------------------------------------------------------- |
| keydata       | 문자열 | 암호화되지 않은 개인키 (접두사 '0x'를 제거한 16진수 문자열) 또는 [Klaytn 지갑 키](../../../klaytn/design/accounts.md#klaytn-wallet-key-format)입니다. |
| oldPassphrase | 문자열 | 이전 개인키를 복호화하기 위한 비밀번호입니다.                                                                                               |
| newPassphrase | 문자열 | 새 개인키를 암호화하기 위한 비밀번호입니다.                                                                                                |
...
| 메시지  | 문자열 | 서명할 메시지입니다.                |
| 계정   | 문자열 | 계정의 주소입니다.                 |
| 비밀번호 | 문자열 | (선택 사항) 암호화에 사용되는 비밀번호입니다. |
