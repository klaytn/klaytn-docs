...
## klay\_encodeAccountKey <a id="klay_encodeaccountkey"></a>
...
## klay\_decodeAccountKey <a id="klay_decodeaccountkey"></a>
...
메시지에 접두사를 붙이면 계산된 서명 값이 Klaytn의 서명임을 알 수 있습니다. This prevents misuse where a malicious BApp can sign arbitrary data, _e.g._, transaction, and use the signature to impersonate the victim.
