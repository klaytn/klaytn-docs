...
이 버전부터 드디어 서비스체인이 공식적으로 지원됩니다. 서비스 체인은 수평적인 확장성을 달성하기 위해 설계된 Klaytn의 layer-2 솔루션입니다. 서비스 체인은 Klaytn 메인체인과 독립적으로 운영되며 자체 거버넌스를 가질 수 있습니다. 서비스체인에 대한 자세한 내용은 https://docs.klaytn.com/klaytn/scaling-solutions 를 방문하세요.
