...
| 논스         | (deprecated) This field is derived from the Ethereum, but not used in Klaytn.                                                                |
...
| governanceMode | 거버넌스를 통제하는 특정 노드의 주소입니다. It only works if the governance mode is `single`. |
...
| Fields                 | 설명                                                                                          |
| ---------------------- | ------------------------------------------------------------------------------------------- |
| mintingAmount          | Amount of peb minted when a block is generated. 값에는 큰따옴표가 필요합니다.                            |
