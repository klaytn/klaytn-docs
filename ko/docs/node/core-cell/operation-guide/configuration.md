...
| NETWORK_ID                     | Klaytn 네트워크 ID입니다.  If you create a local private network, you will define the network ID for your own.  다음은 사전에 구성된 네트워크에 미리 지정된 ID들입니다. <br />8217 : Cypress (Main network) <br />1000 : Aspen test network <br />1001 : Baobab test network |
| PORT                           | P2P 포트                                                                                                                                                                                                                                                                                            |
| SERVER_TYPE                    | JSON RPC 서버 유형  ("http", "fasthttp")                                                                                                                                                                                                                                                              |
| SYNCMODE                       | 블록체인 동기화 모드  ("fast", "full")                                                                                                                                                                                                                                                                     |
| VERBOSITY                      | 상태에 대한 자세한 정보를 기록합니다.  (0=silent, 1=error, 2=warn, 3=info, 4=debug, 5=detail)                                                                                                                                                                                                                     |
| MAXCONNECTIONS                 | 최대로 가능한 물리적 연결 수  All single-channel peers can have up to MAXCONNECTIONS peers.  All multi-channel peers can have up to MAXCONNECTIONS/2 peers.  0으로 설정하면 네트워크 연결이 비활성화됩니다.                                                                                                                       |
| LDBCACHESIZE                   | LevelDB의 메모리 내 캐시 크기 (MiB).                                                                                                                                                                                                                                                                       |
| REWARDBASE                     | 블록 합의 보상을 받을 계정 주소. This property only applies to CN.                                                                                                                                                                                                                                             |
