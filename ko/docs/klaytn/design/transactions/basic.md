...
3. If `to` does not exist on Klaytn, an EOA associated with [AccountKeyLegacy](../accounts.md#accountkeylegacy) is created.
...
| 속성       | 형식                          | 설명                                                                                                                                                                                                                                                                                                                |
|:-------- |:--------------------------- |:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 값        | \*big.Int \(Go\)        | The amount of KLAY in `peb` to be transferred.                                                                                                                                                                                                                                                                    |
...
| 가스       | uint64 \(Go\)             | The maximum amount of transaction fee the transaction is allowed to use.                                                                                                                                                                                                                                          |
...
| 속성           | 형식                                                     | 설명                                                                                                                                                                                                                                                                                                                                  |
|:------------ |:------------------------------------------------------ |:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 형식           | uint8 \(Go\)                                         | The type of TxTypeValueTransfer. This must be 0x08.                                                                                                                                                                                                                                                                                 |
| nonce        | uint64 \(Go\)                                        | A value used to uniquely identify a sender’s transaction. If two transactions with the same nonce are generated by a sender, only one is executed.                                                                                                                                                                                  |
...
| 가스           | uint64 \(Go\)                                        | The maximum amount of gas the transaction is allowed to use.                                                                                                                                                                                                                                                                        |
| to           | common.Address \(Go\)                                | The account address that will receive the transferred value.                                                                                                                                                                                                                                                                        |
| 값            | \*big.Int \(Go\)                                   | The amount of KLAY in `peb` to be transferred.                                                                                                                                                                                                                                                                                      |
...
| 속성           | 형식                                                     | 설명                                                                                                                                                                                                                                                                                                                                  |
|:------------ |:------------------------------------------------------ |:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 형식           | uint8 \(Go\)                                         | The type of TxTypeValueTransferMemo. This must be 0x10.                                                                                                                                                                                                                                                                             |
| nonce        | uint64 \(Go\)                                        | A value used to uniquely identify a sender’s transaction. If two transactions with the same nonce are generated by a sender, only one is executed.                                                                                                                                                                                  |
| gasPrice     | \*big.Int \(Go\)                                   | A unit price of gas in `peb` the sender will pay for a transaction fee. The amount of transaction fee is calculated as `gas` \* `gasPrice`. For example, if the transaction consumes 10 units of gas and gasPrice is 10^18, the transaction fee will be 10 KLAY. See [Unit of KLAY](../klaytn-native-coin-klay.md#units-of-klay). |
| 가스           | uint64 \(Go\)                                        | The maximum amount of gas the transaction is allowed to use.                                                                                                                                                                                                                                                                        |
| to           | common.Address \(Go\)                                | The account address that will receive the transferred value.                                                                                                                                                                                                                                                                        |
...
| 속성            | 형식                                                     | 설명                                                                                                                                                                                                                                                                                                                                  |
|:------------- |:------------------------------------------------------ |:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 형식            | uint8 \(Go\)                                         | The type of TxTypeSmartContractDeploy. This must be 0x28.                                                                                                                                                                                                                                                                           |
| nonce         | uint64 \(Go\)                                        | A value used to uniquely identify a sender’s transaction. If two transactions with the same nonce are generated by a sender, only one is executed.                                                                                                                                                                                  |
| gasPrice      | \*big.Int \(Go\)                                   | A unit price of gas in `peb` the sender will pay for a transaction fee. The amount of transaction fee is calculated as `gas` \* `gasPrice`. For example, if the transaction consumes 10 units of gas and gasPrice is 10^18, the transaction fee will be 10 KLAY. See [Unit of KLAY](../klaytn-native-coin-klay.md#units-of-klay). |
| 가스            | uint64 \(Go\)                                        | The maximum amount of gas the transaction is allowed to use.                                                                                                                                                                                                                                                                        |
...
| 속성           | 형식                                                     | 설명                                                                                                                                                                                                                                                                                                                                  |
|:------------ |:------------------------------------------------------ |:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 형식           | uint8 \(Go\)                                         | The type of TxTypeSmartContractExecution. This must be 0x30.                                                                                                                                                                                                                                                                        |
| nonce        | uint64 \(Go\)                                        | A value used to uniquely identify a sender’s transaction. If two transactions with the same nonce are generated by a sender, only one is executed.                                                                                                                                                                                  |
| gasPrice     | \*big.Int \(Go\)                                   | A unit price of gas in `peb` the sender will pay for a transaction fee. The amount of transaction fee is calculated as `gas` \* `gasPrice`. For example, if the transaction consumes 10 units of gas and gasPrice is 10^18, the transaction fee will be 10 KLAY. See [Unit of KLAY](../klaytn-native-coin-klay.md#units-of-klay). |
| 가스           | uint64 \(Go\)                                        | The maximum amount of gas the transaction is allowed to use.                                                                                                                                                                                                                                                                        |
...
| 속성           | 형식                                                     | 설명                                                                                                                                                                                                                                                                                                                |
|:------------ |:------------------------------------------------------ |:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 형식           | uint8 \(Go\)                                         | The type of TxTypeAccountUpdate. This must be 0x20.                                                                                                                                                                                                                                                               |
| nonce        | uint64 \(Go\)                                        | A value used to uniquely identify a sender’s transaction. If two transactions with the same nonce are generated by a sender, only one is executed.                                                                                                                                                                |
| gasPrice     | \*big.Int \(Go\)                                   | A multiplier to get how much the sender will pay in tokens. The amount of tokens the sender will pay is calculated via `gas` \* `gasPrice`. For example, the sender will pay 10 KLAY for a transaction fee if gas is 10 and gasPrice is 10^18. See [Unit of KLAY](../klaytn-native-coin-klay.md#units-of-klay). |
| 가스           | uint64 \(Go\)                                        | The maximum amount of transaction fee the transaction is allowed to use.                                                                                                                                                                                                                                          |
| from         | common.Address \(Go\)                                | The address of the sender. For more details, see [Signature Validation of Transactions](README.md#signature-validation-of-transactions).                                                                                                                                                                          |
...
| 속성           | 형식                                                     | 설명                                                                                                                                                                                                                                                                                                                                  |
|:------------ |:------------------------------------------------------ |:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 형식           | uint8 \(Go\)                                         | The type of TxTypeCancel. This must be 0x38.                                                                                                                                                                                                                                                                                        |
...
| 속성           | 형식                                                     | 설명                                                                                                                                                                                                                                                                                                                                  |
|:------------ |:------------------------------------------------------ |:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 형식           | uint8 \(Go\)                                         | The type of TxTypeChainDataAnchoringTransaction. This must be 0x48.                                                                                                                                                                                                                                                                 |
| nonce        | uint64 \(Go\)                                        | A value used to uniquely identify a sender’s transaction. If two transactions with the same nonce are generated by a sender, only one is executed.                                                                                                                                                                                  |
| gasPrice     | \*big.Int \(Go\)                                   | A unit price of gas in `peb` the sender will pay for a transaction fee. The amount of transaction fee is calculated as `gas` \* `gasPrice`. For example, if the transaction consumes 10 units of gas and gasPrice is 10^18, the transaction fee will be 10 KLAY. See [Unit of KLAY](../klaytn-native-coin-klay.md#units-of-klay). |
| 가스           | uint64 \(Go\)                                        | The maximum amount of transaction fee the transaction is allowed to use.                                                                                                                                                                                                                                                            |
| from         | common.Address \(Go\)                                | The address of the sender. For more details, see [Signature Validation of Transactions](README.md#signature-validation-of-transactions).                                                                                                                                                                                            |
