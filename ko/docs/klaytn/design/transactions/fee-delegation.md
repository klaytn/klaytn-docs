...
The following changes will apply by this transaction type. 1. The fee payer's balance decreases by the amount of the transaction fee. 2. 발신자의 nonce가 1 증가합니다.
