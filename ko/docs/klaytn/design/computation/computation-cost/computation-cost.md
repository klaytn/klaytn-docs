...
{% hint style="success" %}
NOTE: Computation costs have changed with the `IstanbulEVM` protocol upgrade, or the "hard fork". 이전 문서는 [이전 문서](computation-cost-previous.md)를 참고해주세요.
