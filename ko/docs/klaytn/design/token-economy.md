...
* No.   신규 유저 수: 해당 라운드 기간 동안 서비스 스마트 컨트랙트에 트랜잭션을 1개 이상 보낸 신규 고유 계정 수 입니다.
* No. 재방문 유저 수: 해당 라운드 기간 동안 서비스 스마트 컨트랙트에 트랜잭션을 1개 이상 보낸 재방문 고유 계정 수 입니다.
* No.   트랜잭션 발생 수: 해당 라운드 기간 동안 서비스 스마트컨트랙트를 호출하는 트랜잭션 수 입니다.
