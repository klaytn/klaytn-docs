...
![Klaytn Ecosystem and its Logical Subnetworks \(CCN, ENN, SCN\)](../.gitbook/assets/klaytn_network_overview%20%283%29.png)
...
![Klaytn Main Chain Physical Topology and Tiered Architecture \(CNN, PNN, and ENN\)](../.gitbook/assets/klaytn_network_node.png)
