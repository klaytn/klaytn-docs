...
![Klaytn Ecosystem and its Logical Subnetworks \(CCN, ENN, SCN\)](../.gitbook/assets/klaytn_network_overview%20%282%29.png)
...
![Klaytn Main Chain Physical Topology and Tiered Architecture \(CNN, PNN, and ENN\)](../.gitbook/assets/klaytn_network_node%20%281%29.png)
