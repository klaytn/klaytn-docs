...
It has been enabled from block number `#75373312` in case of the Baobab network.
...
It has been enabled from block number `#80295291` in case of the Baobab network.
Cypress mainnet will be subject to the same protocol upgrade in the next version.
{% endhint %}
