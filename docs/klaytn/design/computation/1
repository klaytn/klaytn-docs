...
Therefore, we chose the third option and implemented it in Klaytn. For now, the limit of the execution cost is set to 100,000,000. Since the limitation is determined by the platform, developers should know the computation cost of a transaction. To get the computation cost of a transaction, Klaytn provides [klay\_estimateComputationCost](../../../bapp/json-rpc/api-references/platform/transaction.md#klay_estimatecomputationcost). The usage is almost the same as [klay\_estimateGas](../../../bapp/json-rpc/api-references/platform/transaction.md#klay_estimategas).
