...
* A transaction which has bigger execution cost than a computation cost limit is discarded. Please refer to [computation cost](computation-cost/computation-cost.md)
