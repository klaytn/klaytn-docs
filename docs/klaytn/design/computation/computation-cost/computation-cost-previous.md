...
{% hint style="success" %}
NOTE: Below computation costs are used before the incompatible change, in other words, hard fork introduced in klaytn v1.7.0.
If you want the latest document, please refer [latest document](computation-cost.md).
{% endhint %}
