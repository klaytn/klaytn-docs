...
{% hint style="success" %} 
NOTE: Since Klaytn has adopted a unit gas price policy, `gasTipCap` and `gasFeeCap` should take the network unit gas price, which is 25 ston at the time of writing.
{% endhint %}
