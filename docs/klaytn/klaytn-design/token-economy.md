...
| **Basic Requirements** | \(1\) Services are required to set up fee delegation structure for users. [Checkout Fee Delegation Example here.](https://github.com/tinaklay/docs-overview/tree/0f357c3c0311d48c599d79074853dd73f66e4c7f/tutorials/feedelegated/feedelegated.md)   \(2\) Services must be completed onboarding Cypress \(Klaytn Mainnet\). To start onboarding, please [request fee delegation key here](https://klaytn.typeform.com/to/op3xWQ). |
