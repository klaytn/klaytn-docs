...
For more information about the gas price, see [GasPrice Overview](../../../learn/transaction-fees/transaction-fees.md#gasprice-overview-a-idgas-price-overviewa) The price of gas used in the network can be obtained by using [caver.rpc.klay.getGasPrice](./api/caver-rpc/klay.md#caver-rpc-klay-getgasprice).
