...
We will focus only on the code modifications required to migrate an Ethereum App to Klaytn. If you need details on creating a Klaytn BApp, Please refer to [CountBApp Tutorial](count-bapp/).
...
![blocknumber component](../../.gitbook/assets/blocknumber-component.gif)
...
![count component](../../.gitbook/assets/count-component.gif)
