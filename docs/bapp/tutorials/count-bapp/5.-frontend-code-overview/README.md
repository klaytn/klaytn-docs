...
For further information related `caver.klay.accounts.wallet.add`, see [caver.klay.accounts.wallet.add](../../../../sdk/caver-js/api-references/caver.klay.accounts#wallet-add)
