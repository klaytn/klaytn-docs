...
1. Convert photo file as a bytes string to load on transaction  
   ...
   \(In [Klaystagram contract](https://github.com/tinaklay/docs-bapps/tree/ef3c8508a3d5b5247b8d044f32339de6a9d585e4/tutorials/klaystagram/7.-feedpage/4-write-smart-contract.md), we defined photo fotmat as bytes in `PhotoData` struct\)  
