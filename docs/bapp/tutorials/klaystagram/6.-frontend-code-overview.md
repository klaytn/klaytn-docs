...
cf. For further information about caver's `privateKeyToAccount` API, see [caver.klay.accounts.privateKeyToAccount](../../../bapp/sdk/caver-js/api-references/caver.klay.accounts.md#privatekeytoaccount).
