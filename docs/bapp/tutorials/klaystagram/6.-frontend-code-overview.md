...
cf. caver-js\(or `cav` in the code\) is a library for interacting with Klaytn blockchain. We are going to learn in detail in the next chapter - [7-1. Connect Contract to Frontend](https://github.com/tinaklay/docs-bapps/tree/ef3c8508a3d5b5247b8d044f32339de6a9d585e4/tutorials/klaystagram/7-1-feedpage-connect-contract.md)
...
cf. For further information about caver's `privateKeyToAccount` API, see [caver.klay.accounts.privateKeyToAccount](https://github.com/tinaklay/docs-bapps/tree/ef3c8508a3d5b5247b8d044f32339de6a9d585e4/sdk/caverjs/caver.klay.accounts.md#privatekeytoaccount).
...
please refer to the [5.2. Auth Component](https://github.com/tinaklay/docs-bapps/tree/ef3c8508a3d5b5247b8d044f32339de6a9d585e4/tutorials/countbapp/5-2-frontend-auth-component.md) page.
