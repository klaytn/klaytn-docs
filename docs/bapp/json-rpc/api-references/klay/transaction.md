...
Creates a new message call transaction or a contract creation if the data field contains code. This API supports Klaytn transaction types and the usage is described in [Transaction Type Supports](./transaction/transaction-type-support).
...
Creates a rawTransaction based on the give transaction information. This API supports Klaytn transaction types and the usage is described in [Transaction Type Supports](./transaction/transaction-type-support).
