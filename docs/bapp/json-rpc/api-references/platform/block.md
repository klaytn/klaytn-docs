...
| Type | Description |
| :--- | :--- |
| QUANTITY \| TAG | Integer of a block number, or the string `"earliest"`, `"latest"` or `"pending"`, as in the [default block parameter](block.md#the-default-block-parameter). |
...
## klay\_getBlockWithConsensusInfoByHash
