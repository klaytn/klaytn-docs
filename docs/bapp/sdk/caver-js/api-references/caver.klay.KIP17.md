...
The `caver.klay.KIP17`, a javascript object, makes it easy to interact with a smart contract that implements [KIP-17](http://kips.klaytn.com/KIPs/kip-17) on the Klaytn blockchain. 
...
For more information about KIP-17, see [Klaytn Improvement Proposals](http://kips.klaytn.com/KIPs/kip-17).
...
```
Safely transfers the ownership of a given token id to another address. If the target address is a contract, it must implement [IKIP17Receiver.onKIP17Received](http://kips.klaytn.com/KIPs/kip-17#wallet-interface). otherwise, the transfer is reverted.
