...
Plain transaction objects of type `FEE_DELEGATED_VALUE_TRANSFER` with the above structure or `RLP-encoded transactions` of type `FEE_DELEGATED_VALUE_TRANSFER` can be used as parameters in [caver.klay.accounts.signTransaction](../caver.klay.accounts.md#signtransaction) for sender and [caver.klay.accounts.feePayerSignTransaction](../caver.klay.accounts.md#feepayersigntransaction) for fee payer.
...
Plain transaction objects of type `FEE_DELEGATED_VALUE_TRANSFER_WITH_RATIO` with the above structure or `RLP-encoded transactions` of type `FEE_DELEGATED_VALUE_TRANSFER_WITH_RATIO` can be used as parameters in [caver.klay.accounts.signTransaction](../caver.klay.accounts.md#signtransaction) for sender and [caver.klay.accounts.feePayerSignTransaction](../caver.klay.accounts.md#feepayersigntransaction) for fee payer.
