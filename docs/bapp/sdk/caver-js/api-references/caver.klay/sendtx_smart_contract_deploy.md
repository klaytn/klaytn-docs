...
| value  | Number &#124; String &#124; BN &#124; BigNumber | The value that will be transferred to the contract with this deployment. If the contract modifier is not payable, value must be zero. |
