...
Account is a class containing the address and key of an account. The Account has an [AccountKey](getting-started.md#accountkey), which can be of type [AccountKeyPublic](getting-started.md#accountkeypublic), [AccountKeyMultiSig](getting-started.md#accountkeymultisig), or [AccountKeyRoleBased](getting-started.md#accountkeyrolebased).

The caver.klay.accounts package uses [AccountKeyPublic](getting-started.md#accountkeypublic), which stores and manages a private key string by default.
...
An explanation of the various AccountKey classes is provided in the [AccountKey](getting-started.md#accountkey) part.
...
The following [AccountForUpdate](getting-started.md#accountforupdate) explains how to update an account by sending a transaction to the Klaytn network.
