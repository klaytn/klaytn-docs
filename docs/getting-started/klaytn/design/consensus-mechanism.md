...
[Bitcoin](https://en.wikipedia.org/wiki/Bitcoin) is using [PoW](https://en.wikipedia.org/wiki/Proof\_of\_work) (Proof-of-Work), whereas Ethereum has recently shifted to [PoS](https://en.wikipedia.org/wiki/Proof\_of\_stake) (Proof-of-Stake), which decides on the block generating nodes by the stake of the node. Usually, these algorithms involve no communication between nodes in determining the validities of blocks.
...
![PBFT message flow](../../../klaytn/images/pbft.png)
...
## Consensus Mechanism in Klaytn <a href="#consensus-mechanism-in-klaytn" id="consensus-mechanism-in-klaytn"></a>
...
![Network topology](../../../klaytn/images/klaytn\_network\_node.png)
...
![Concept of council and committee](../../../klaytn/images/council-committee.png)
