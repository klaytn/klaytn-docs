...
Klaytn v1.10.2 contains a hardfork upgrade that results in backward-incompatible changes. All Baobab/Cypress nodes would thus have to be upgraded to v1.10.2 or higher before the target block number. The hardfork implements [[KIP-103](https://github.com/klaytn/kips/pull/104)] that is a technical specification of [[KGP-6](https://govforum.klaytn.foundation/t/kgp-6-proposal-to-establish-a-sustainable-and-verifiable-klay-token-economy/157)].
...
*You can find detailed information on TreasuryRebalance contract from [KIP-103](https://github.com/klaytn/kips/pull/104)
...
## Hardfork features 
- [KIP-103](https://github.com/klaytn/kips/pull/104): Implementing TreasuryRebalance (#1803 #1809 #1810)
