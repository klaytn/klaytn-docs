...
If you're curious about the creation of this hardware spec, [Determining optimal hardware specs for Klaytn node operators](https://klaytn.foundation/node-operator-optimal-specs/) article would help you understand.
