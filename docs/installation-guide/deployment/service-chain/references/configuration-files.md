...
| NETWORK_ID | Klaytn network ID.  If you create a local private network, you will define the network ID for your own.  Following IDs are reserved for pre-configured networks.  <br></br>8217 : Cypress (Main network) <br></br>1000 : Aspen test network <br></br>1001 : Baobab test network |
