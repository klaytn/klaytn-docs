...
This section describes the steps for applying Klaytn [hard forks](../../../../klaytn-history/) to ServiceChain.
...
You can find the history of Klaytn hard forks in the [Klaytn Docs](../../../../klaytn-history/).
