...
- Keystore V4
  - Klaytn implemented a new keystore standard [KIP-3](https://klaytn.github.io/kips/KIPs/kip-3) to support Klaytn accounts.
...
- Optimized storage trie
  ...
  - Klaytn concurrently computes for trie hash roots.
