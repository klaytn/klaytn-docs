...
## Fixes
 - Returned the same receipt status with Ethereum for eth_getTransactionReceipt API (#1257)
 - Removed EthereumTxTypeEnvelope from raw transaction API returns (#1264)
 - Returned null for the non-existing block in eth namespace APIs (#1261 #1267)