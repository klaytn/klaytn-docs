...
* Enter the Endpoint Node (EN) data of the Klaytn chain.
  ...
  * Baobab
    ...
    * New RPC URL: [https://api.baobab.klaytn.net:8651](https://api.baobab.klaytn.net:8651) (Default: [https://api.baobab.klaytn.net:8651](https://api.baobab.klaytn.net:8651/))
