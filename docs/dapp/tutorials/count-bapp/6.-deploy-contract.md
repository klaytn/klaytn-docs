...
* b. From the terminal using curl If you already have your Klaytn account\(address\), type the command below in your terminal. `$ curl "https://baobab.wallet.klaytn.foundation/api/faucet/?address=YOUR_ADDRESS"` example\) `$ curl "https://baobab.wallet.klaytn.foundation/api/faucet/?address=0x785172fBc2DB6BD6DA59927E79B43EDAa88d58d4"`
