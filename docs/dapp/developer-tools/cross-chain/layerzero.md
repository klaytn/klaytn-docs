...
![](../images/crosschain-tokens-visuals.png)
...
* A fresh Hardhat project and [knowledge of how to use Hardhat](https://docs.klaytn.foundation/content/getting-started/hardhat)
