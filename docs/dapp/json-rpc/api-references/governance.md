...
| `"governance.deriveshaimpl"`| `NUMBER`. Policy to generate transaction hash and receipt hash in a block header. See [here](https://github.com/klaytn/klaytn/blob/5025e0f61e2d5584042f06fde99ff9f8246ee223/blockchain/types/derivesha/mux.go#L50-L54) for available options. e.g., `2` (DeriveShaConcat) |
