...
| effectiveGasPrice                  | (added)                                                                                  | **(Note that)** Klaytn uses fixed gasPrice policy. gasPrice(also called [Unit Price](https://docs.klaytn.com/klaytn/design/transaction-fees#unit-price)) is set in the system by the governance.                                          |
| from                               | from                                                                                     | (Same with Ethereum) Address of the sender.                                                                                                                                                                                               |
