...
| miner                 | (added)                 | **(Note that)** Because the [consensus mechanism](../../../klaytn/design/consensus-mechanism.md) in Klaytn is [PBFT](../../../klaytn/design/consensus-mechanism#pbft-practical-byzantine-fault-tolerance.md), there is a block proposer not miner. So it returns the address of proposer of the block.                                                                                                                                                |
