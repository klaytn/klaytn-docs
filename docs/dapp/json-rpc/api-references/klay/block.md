...
```shell
// Request
curl -H "Content-Type: application/json" --data '{"jsonrpc":"2.0","method":"klay_getHeaderByNumber","params":["0x1e67"],"id":1}' http://localhost:8551
// Result
{
  "jsonrpc":"2.0",
  "id":1,
...
```shell
// Request
curl -H "Content-Type: application/json" --data '{"jsonrpc":"2.0","method":"klay_getHeaderByHash","params":["0xe882d7a16f38126dc0c507f990b3fe18fa2d3a380002538581327abe96ca6edc"],"id":1}' http://localhost:8551
// Result
{
  "jsonrpc":"2.0",
  "id":1,
...
```shell
// Request
curl -H "Content-Type: application/json" --data '{"jsonrpc":"2.0","method":"klay_getBlockByNumber","params":["0x1e67", true],"id":1}' http://localhost:8551
...
```shell
// Request
curl -H "Content-Type: application/json" --data '{"jsonrpc":"2.0","method":"klay_getBlockByHash","params":["0xe882d7a16f38126dc0c507f990b3fe18fa2d3a380002538581327abe96ca6edc", true],"id":1}' http://localhost:8551
