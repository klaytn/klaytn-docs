...
It validates that the message is signed by the given account. 
Klaytn has several [accountKey](https://docs.klaytn.foundation/content/klaytn/design/accounts#account-key) types.
...
Additionally this function has a ability to validate a signature in the two kind of prefix when signing a message, 
