...
## unsafedebug_freeOSMemory <a id="unsafedebug_freeosmemory"></a>

Returns unused memory to the OS.

| Client  | Method Invocation                  |
|:-------:|------------------------------------|
| Console | `unsafedebug.freeOSMemory()`             |
| RPC     | `{"method": "unsafedebug_freeOSMemory"}` |
...
Console
```javascript
> unsafedebug.freeOSMemory()
null
```
HTTP RPC
```shell
$ curl -H "Content-Type: application/json" --data '{"jsonrpc":"2.0","method":"unsafedebug_freeOSMemory","id":1}' https://api.baobab.klaytn.net:8651
{"jsonrpc":"2.0","id":1,"result":null}
```


## unsafedebug_gcStats <a id="unsafedebug_gcstats"></a>

Returns GC statistics.

| Client  | Method Invocation                                 |
|:-------:|---------------------------------------------------|
| Console | `unsafedebug.gcStats()`                                 |
| RPC     | `{"method": "unsafedebug_gcStats", "params": []}`       |
...
HTTP RPC
```shell
$ curl -H "Content-Type: application/json" --data '{"jsonrpc":"2.0","method":"unsafedebug_gcStats","params":[],"id":1}' https://api.baobab.klaytn.net:8651
...
## unsafedebug_memStats <a id="unsafedebug_memstats"></a>

Returns detailed runtime memory statistics.

| Client  | Method Invocation                                 |
|:-------:|---------------------------------------------------|
| Console | `unsafedebug.memStats()`                                |
| RPC     | `{"method": "unsafedebug_memStats", "params": []}`      |
...
HTTP RPC
```shell
$ curl -H "Content-Type: application/json" --data '{"jsonrpc":"2.0","method":"unsafedebug_memStats","params":[],"id":1}' https://api.baobab.klaytn.net:8651
...
## unsafedebug_metrics <a id="unsafedebug_metrics"></a>

Retrieves all the known system metrics collected by the node.

| Client  | Method Invocation                              |
|:-------:|------------------------------------------------|
| Console | `unsafedebug.metrics(raw)`                           |
| RPC     | `{"method": "unsafedebug_metrics", "params": [raw]}` |
...
HTTP RPC
```shell
$ curl -H "Content-Type: application/json" --data '{"jsonrpc":"2.0","method":"unsafedebug_metrics","params":[true],"id":1}' https://api.baobab.klaytn.net:8651
...
## unsafedebug_setGCPercent <a id="unsafedebug_setgcpercent"></a>
...
Console
```javascript
> unsafedebug.setGCPercent(50)
100
> unsafedebug.setGCPercent(70)
50
> unsafedebug.setGCPercent(100)
70
```
HTTP RPC
```shell
curl -X POST -H "Content-Type: application/json" --data '{"jsonrpc":"2.0", "method":"unsafedebug_setGCPercent", "params":[100],"id":73}' https://api.baobab.klaytn.net:8651
...
## unsafedebug_stacks <a id="unsafedebug_stacks"></a>

Returns a printed representation of the stacks of all goroutines.

| Client  | Method Invocation                                 |
|:-------:|---------------------------------------------------|
| Console | `unsafedebug.stacks()`                                  |
| RPC     | `{"method": "unsafedebug_stacks", "params": []}`        |
...
HTTP RPC
```shell
$ curl -H "Content-Type: application/json" --data '{"jsonrpc":"2.0","method":"unsafedebug_stacks","params":[],"id":1}' https://api.baobab.klaytn.net:8651
