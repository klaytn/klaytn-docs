...
Before Magma hard fork, `suggestGasPrice` returns unit price.
After Magma hard fork, `suggestGasPrice` returns `baseFee * 2` which is recommended to use as a gasPrice.
