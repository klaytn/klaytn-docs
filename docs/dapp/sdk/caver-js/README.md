...
For more information about the gas price, see [Gas and Unit Price Overview](../../../getting-started/klaytn/design/transaction-fees/#gas-and-unit-price-overview) The price of gas used in the network can be obtained by using [caver.rpc.klay.getGasPrice](api-references/caver.rpc/klay.md#caver-rpc-klay-getgasprice).
