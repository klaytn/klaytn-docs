...
This tutorial helps you to create an example ERC-721 compatible token that conforms to [Klaytn Token Standards](../../klaytn/design/computation/token_standard.md), especially [Non-fungible Token Standard (ERC-721)](../../klaytn/design/computation/token_standard.md#non-fungible-token-standard-erc-721).
