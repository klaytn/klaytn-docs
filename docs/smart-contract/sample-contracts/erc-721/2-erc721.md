...
* Please visit [Remix Online IDE](https://remix.ethereum.org/) and create a `MyERC721Card` contract. The complete source code is given at [Writing ERC-721 Smart Contract](1-erc721.md).
