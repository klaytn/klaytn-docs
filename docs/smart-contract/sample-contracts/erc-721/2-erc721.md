...
* Please visit the Remix Online IDE website and create a `MyERC721Card` contract. The complete source code was given at [Writing ERC-721 Smart Contract](1-erc721.md).
