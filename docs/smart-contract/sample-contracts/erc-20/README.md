...
This tutorial helps you to create an example ERC-20 compatible token that comforms to the [Klaytn Token Standards](https://github.com/tinaklay/docs-contract/tree/cf868ceb857f121439d5f48bc3879169fb82f77c/klaytn/design/computation/token_standard.md), especially [Fungible Token Standard \(ERC-20\)](https://github.com/tinaklay/docs-contract/tree/cf868ceb857f121439d5f48bc3879169fb82f77c/klaytn/design/computation/token_standard.md#fungible-token-standard-erc-20).
