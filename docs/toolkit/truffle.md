...
## Compatibility with Truffle <a href="#compatibility-with-truffle" id="compatibility-with-truffle"></a>
...
## Configuring truffle-hdwallet-provider-klaytn <a href="#configuring-truffle-hdwallet-provider-klaytn" id="configuring-truffle-hdwallet-provider-klaytn"></a>
...
### Using a mnemonic <a href="#using-a-mnemonic" id="using-a-mnemonic"></a>
...
### Using a private key <a href="#using-a-private-key" id="using-a-private-key"></a>
