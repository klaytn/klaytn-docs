...
* TX Type: Type of the transaction. You can apply a filter to get the transactions of a specific type. For more information, please visit [Transactions](https://github.com/tinaklay/docs-contract/tree/cf868ceb857f121439d5f48bc3879169fb82f77c/klaytn/design/transactions.md).
...
* TX Type: Type of the transaction. For more information, please see [Transactions](https://github.com/tinaklay/docs-contract/tree/cf868ceb857f121439d5f48bc3879169fb82f77c/klaytn/design/transactions.md).
