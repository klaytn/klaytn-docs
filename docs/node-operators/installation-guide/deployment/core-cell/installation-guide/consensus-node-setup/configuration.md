...
## CN Data Directory Creation <a href="#cn-data-directory-creation" id="cn-data-directory-creation"></a>
...
### Setup Rewardbase <a href="#setup-rewardbase" id="setup-rewardbase"></a>
...
Keep in mind that the keystore and the password that you created is significantly important, so you must be careful to manage them. See more details about `kcnd.conf` on the [Configuration File](../../../../../../installation-guide/deployment/core-cell/operation-guide/configuration.md) section.
