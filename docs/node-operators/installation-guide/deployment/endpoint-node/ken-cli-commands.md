...
### Module APIs <a href="#module-apis" id="module-apis"></a>

If you type the module name on the console prompt, you will see the available properties and functions of the module. For the details of functions, please see [Klaytn API](../../../../installation-guide/dapp/json-rpc/api-references/).
