...
![](../../../../../installation-guide/deployment/service-chain/images/sc-nestedsc-arch.png)
...
### Step 1: Create and update Homi data for L3 <a href="#step-1-create-and-update-homi" id="step-1-create-and-update-homi"></a>
...
![](../../../../../installation-guide/deployment/service-chain/images/sc-nestedsc-ip.png)
...
### Step 2: SCN configuration in L3 <a href="#step-2-scn-configuration" id="step-2-scn-configuration"></a>
...
### Step 3: Restart after setting L2 main bridge <a href="#step-3-restart-after-setting-l2-main-bridge" id="step-3-restart-after-setting-l2-main-bridge"></a>
...
![](../../../../../installation-guide/deployment/service-chain/images/sc-nestedsc-id.png)
...
### Step 4: Check KNI of Main Bridge Node <a href="#step-4-check-kni-of-main-bridge-node" id="step-4-check-kni-of-main-bridge-node"></a>
...
![](../../../../../installation-guide/deployment/service-chain/images/sc-nestedsc-nodeinfo.png)
...
### Step 5: Configure L3 sub-bridge <a href="#step-5-configure-l3-sub-bridge" id="step-5-configure-l3-sub-bridge"></a>
