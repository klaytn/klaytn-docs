...
### kscn console <a href="#kscn-console" id="kscn-console"></a>
...
You can check the usable commands on [API Document](../../../../../../installation-guide/bapp/json-rpc/)
