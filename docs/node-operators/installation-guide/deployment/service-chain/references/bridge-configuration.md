...
After attaching to the process via IPC, you can check the EN's main-bridge KNI like below. You can refer to [Service Chain API](../../../../../installation-guide/bapp/json-rpc/api-references/servicechain.md).
