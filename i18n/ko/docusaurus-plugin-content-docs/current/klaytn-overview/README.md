...
> To set up a Service Chain for your application, read the [TEMP - installation and operation guide of Service Chain](../intro.md).
...
> If you are interested in being a Core Cell Operator, read the [TEMP - installation and operation guide of Core Cell](../intro.md).
...
> To set up an Endpoint Node for your application, read the [TEMP - installation and operation guide of Endpoint Node](../intro.md).
...
a WAN (wide area network) and requires each CN to satisfy [TEMP - stringent hardware and network resource requirements](../intro.md) to carry out BFT consensus at a sufficient performance level. 
...
can be found in the [TEMP - Klaytn Token Economy](../intro.md) section.
