...
A council of organizations that are responsible for governing the Klaytn blockchain. GC 멤버는 클레이튼 재단이 선정하며, 클레이튼 네트워크에서 합의 노드를 운영해야 합니다. GC는 업그레이드, 파트너십, 생태계 개발 이니셔티브 등 클레이튼 블록체인의 개발과 운영에 관한 의사결정을 내릴 책임이 있습니다.
