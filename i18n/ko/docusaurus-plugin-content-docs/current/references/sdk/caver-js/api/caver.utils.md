...
| 유형     | 설명                                                                                                                                                  |
| ------ | --------------------------------------------------------------------------------------------------------------------------------------------------- |
| Object | 클레이튼에서 사용되는 KLAY의 단위가 정의된 객체입니다. Each unit has its name and pebFactor. 각 단위에는 이름과 pebFactor가 있으며, 현재 각 단위로 변환된 KLAY를 'peb'로 변환할 때 pebFactor가 사용됩니다. |
...
| 이름     | 유형     | 설명                         |
| ------ | ------ | -------------------------- |
| String | string | A hex string to make even. |
...
| 이름      | 유형     | Description                                      |
| ------- | ------ | ------------------------------------------------ |
| message | string | A message to hash. HEX 문자열인 경우 UTF-8로 먼저 디코딩됩니다. |
