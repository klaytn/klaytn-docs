...
클레이튼은 고정 가스 가격 \(25 ston = 25 \* 10^9\)을 사용합니다. 클레이튼 네트워크에 제출된 다른 가격의 트랜잭션은 거부됩니다. 가스 가격에 대한 자세한 내용은 [가스 및 단가 개요](../../../learn/transaction-fees.md#gas-and-unit-price-overview)를 참고하세요. 네트워크에서 사용되는 가스 가격은 [caver.klay.getGasPrice](./api/caver.klay/config.md#getgasprice)를 통해 얻을 수 있습니다.
